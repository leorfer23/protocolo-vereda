...
| 5 | vereda-nodo | Mock: un **MP falso** en `mock/` (autoriza, crea preferencia, página de "pagar/rechazar", manda el webhook firmado) para los e2e de la webapp y el QA agéntico | 4 | S |
