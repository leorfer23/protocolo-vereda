...
| `pago.pendiente`, `pago.confirmado`, `pago.vencido`, `pago.fallido` | Desde el adaptador de PSP o al confirmar transferencia/efectivo |
| `pago.reembolsado`, `pago.contracargo` | Informativos: el proveedor avisó una devolución o un contracargo (`docs/cobro-con-psp.md`). El contracargo no mueve plata en el nodo |
