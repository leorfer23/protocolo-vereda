...
| Carpeta | Contenido |
| --- | --- |
| `esquemas/` | 25 esquemas JSON (draft 2020-12): comercio, oferta, promoción, modalidad, carrito, pedido, pago, sostenimiento del nodo, repartidor, usuario, reseña, denuncia, reclamo, suscripción, lista, catálogo maestro, ronda, grupo, viaje, mandato, mensaje, cotización, evento, error, comunes |
| `openapi.yaml` | La API abierta, 92 rutas. Apps y agentes usan las mismas |
