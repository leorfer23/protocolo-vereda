...
| Carpeta | Contenido |
| --- | --- |
| `esquemas/` | 23 esquemas JSON (draft 2020-12): comercio, oferta, promoción, modalidad, carrito, pedido, pago, repartidor, usuario, reseña, denuncia, suscripción, lista, catálogo maestro, ronda, grupo, viaje, mandato, mensaje, cotización, evento, error, comunes |
| `openapi.yaml` | La API abierta, 87 rutas. Apps y agentes usan las mismas |
...
| `docs/` | Federación (con mudanza, disputas y catálogo maestro), claves y firmas, eventos y webhooks, ranking y despacho, repartidores (asignación, responsabilidad, cobro y reputación), reseñas y reputación contextual, identidad y verificación sin autoridad (vinculaciones, duplicados, denuncias), carrito y reserva, promociones, datos y privacidad, diseño de la suite de conformidad (fase 1) |
